...
The audit logbook for live cluster state (partitions, idle capacity,
environment quirks) is `docs/hpc.md` — re-audit before any consequential
submission; snapshots go stale.
