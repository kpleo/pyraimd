"""Build the Li(100)|LP30-electrolyte dual-interface box (flagship A, design-m3.md v2.1).

Spec (design-m3.md "Build specs", v2.1 anchored):
...
- electrolyte: 21 EC + 17 DMC + 3 LiPF6 (438 atoms, LP30-class: 1 M LiPF6 in
  ...
  J. Electrochem. Soc. 2016, DOI 10.1149/2.0771605jes — replaces the
  untraceable 1.289 value, see the v2.1 audit in design-m3.md)
- box ~10.5 x 10.5 x ~52 A (lateral exactly 3*a = 10.53 A), PBC everywhere
- packing: Packmol, tolerance 2.0 A (packmol default; design-m3.md precedent
  arXiv:2606.09422), seeded. Classical-FF NPT pre-equilibration and the 450 K
...
PROVENANCE = {
    ...
    "packing": "Packmol, tolerance 2.0 A (packmol default; design-m3.md v2.1 "
    "precedent arXiv:2606.09422); slab as fixed structure, solvent constrained "
...
def render_packmol_input(plan: BuildPlan) -> str:
    ...
    lines = [
        "# Li(100)|LP30 dual-interface box (flagship A, design-m3.md v2.1)",
...
def main() -> None:
    ...
    comment = (
        "Li(100)|LP30 dual interface (design-m3.md v2.1); packed with packmol "
